...
import io.trellis.service.SecurityChainInfoService.SecurityChainInfo;
	...
	public List<NodeParameter> getParameters() {
		return List.of(
			...
			NodeParameter.builder()
				.name("webhookNotice")
				.displayName("Notice")
				.description("Insert a 'Respond to Webhook' node to control when and how you respond. <a href=\"https://docs.trellis.io/nodes/respond-to-webhook\" target=\"_blank\">More info</a>")
