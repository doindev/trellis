...
const CwcTriggerNode = memo(({ id, data, selected }: NodeProps & { data: CwcTriggerNodeData }) => {
  ...
  const nodeContent = (
    <div className={`cwc-node trigger-node icon-only${statusClass}${selectedClass}${disabledClass}`}>
...
CwcTriggerNode.displayName = 'CwcTriggerNode';
export default CwcTriggerNode;
